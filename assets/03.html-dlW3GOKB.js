import{_ as t}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as a,c as i,a as e,d as n}from"./app-olfm5N8J.js";const o={},r=n("h2",{id:"基础标签",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#基础标签"},[n("span",null,"基础标签")])],-1);function l(s,d){return a(),i("div",null,[e(" more "),r,e(` 
<h1></h1>    <h6></h6>                     标题标签
<p></p>                                    段落标签
<i></i>     <em></em>                      斜体显示
...
（1）：引入flxible.js插件
        <script src=""><\/script>
（2）:去掉html里面默认的meta标签
        <meta name="viewport" content="width=device-width, initial-scale=1.0"> `)])}const m=t(o,[["render",l],["__file","03.html.vue"]]);export{m as default};
