<template><div><p>HTML和CSS的基础知识，它们是构建Web页面的基础。HTML用于定义页面的结构，CSS用于定义页面的样式和布局。HTML和CSS是前端开发中不可缺少的技能，它们是构建Web页面的基础。</p>
<!-- more -->
<h1 id="常用布局" tabindex="-1"><a class="header-anchor" href="#常用布局"><span>常用布局</span></a></h1>
...
<h4 id="flex-direction-子元素排列顺序" tabindex="-1"><a class="header-anchor" href="#flex-direction-子元素排列顺序"><span>flex-direction（子元素排列顺序）</span></a></h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="flex-wrap-换行" tabindex="-1"><a class="header-anchor" href="#flex-wrap-换行"><span>flex-wrap（换行）</span></a></h5>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="flex-flow" tabindex="-1"><a class="header-anchor" href="#flex-flow"><span>flex-flow</span></a></h5>
...
使用方法：
例：
 <img src="@source/frontend/HTMLCSS/imgs/1.jpg" alt="" usemap="#map1" />
